function uploadFile() {
    ...
    if (file) {
        ...
        fetch('http://ec2-18-207-221-99.compute-1.amazonaws.com:9000uploadfile/', {
            method: 'POST',
            body: formData,
        })
...
function renameFile(filename) {
            ...
            if (name !== '') {
                fetch(`http://ec2-18-207-221-99.compute-1.amazonaws.com:9000/renamefile/${filename}/${name}/`, {
                    method: 'PUT',
                })
                .then(response => response.json())
                .then(data => {
        ...
        async function getFileList() {
            try {
                const response = await fetch('http://ec2-18-207-221-99.compute-1.amazonaws.com:9000/listfiles/');
        ...
        async function deleteFile(fileName) {
            try {
                const response = await fetch(`http://ec2-18-207-221-99.compute-1.amazonaws.com:9000/deletefile/${fileName}/`, {
                    method: 'DELETE',
                });
                const data = await response.json();
