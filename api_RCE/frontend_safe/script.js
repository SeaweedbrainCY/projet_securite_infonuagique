function uploadFile() {
    ...
    if (file) {
        ...
        fetch('http://safe-api.rce.demo.stchepinsky.net/uploadfile/', {
            method: 'POST',
            body: formData,
        })
...
function renameFile(filename) {
            ...
            if (name !== '') {
                fetch(`http://safe-api.rce.demo.stchepinsky.net/renamefile/${filename}/${name}/`, {
                    method: 'PUT',
                })
                .then(response => response.json())
                .then(data => {
        ...
        async function getFileList() {
            try {
                const response = await fetch('http://safe-api.rce.demo.stchepinsky.net/listfiles/');
        ...
        async function deleteFile(fileName) {
            try {
                const response = await fetch(`http://safe-api.rce.demo.stchepinsky.net/deletefile/${fileName}/`, {
                    method: 'DELETE',
                });
                const data = await response.json();
