...
#OK ça marche
@app.post("/api-secure/token", response_model=dict)
...
#OK ça marche
@app.post("/api-secure/register", response_model=dict)
...
@app.get("/api-secure/protected_resource", response_model=dict)
